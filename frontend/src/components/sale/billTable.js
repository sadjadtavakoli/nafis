                                ...
                                return (
                                    <div>
                                        <Table.Row key={index}>
                                            ...
                                            <Table.Cell className="norm-latin text-center">{item.final_discount ? (<div><span className="yekan">digitToComma(item.final_discount)</span><span className="yekan">تومان</span></div>) : '--'}  </Table.Cell>
